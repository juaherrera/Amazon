    ...
    return (
        <>
            ...
            <Row>
                ...
                {params.isAuth && <>
                    {!wish ? (
                        <OverlayTrigger placement="top" overlay={<Tooltip>Añadir a la lista de deseos</Tooltip>}>
                            <BsHeart />
                        </OverlayTrigger>
                    )
                        : (
                            <OverlayTrigger placement="top" overlay={<Tooltip>Eliminar de la lista de deseos</Tooltip>}>
                                <BsHeartFill />
                            </OverlayTrigger>
                        )
                    }
            ...
            <div id="detailsCardText" className="col-lg-12">
                <Tabs defaultActiveKey="details" transition={false}>
                    <Tab eventKey="details" title="Details" id="tab-details">
                        {params.description}
                        <hr />
                        <p id="details-footer" className="text-muted">Producto listado en {params.addedAt}</p>
                    </Tab>
