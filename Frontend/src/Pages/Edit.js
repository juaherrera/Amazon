                ...
                <Form onSubmit={onSubmitHandler}>
                    ...
                    <Form.Row>
                        <Form.Group as={Col} controlId="formGridTitle">
                            ...
                            <Form.Control type="text" placeholder="Introduce el título" name="title" value={product.title} onChange={onChangeHandler} required />
                        </Form.Group>

                        <Form.Group as={Col} controlId="formGridPrice">
                            <Form.Label>Price</Form.Label>
                            <Form.Control type="number" step="0.01" placeholder="Precio" name="price" value={product.price} onChange={onChangeHandler} required />
                        </Form.Group>
                    </Form.Row>
                    ...
                    <Form.Row>
                        <Form.Group as={Col} controlId="formGridCity">
                            ...
                            <Form.Control name="city" placeholder="Madrid" value={product.city} onChange={onChangeHandler} required />
                        </Form.Group>
