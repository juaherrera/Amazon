                            ...
                            <Col lg={3} md={5} sm={12}>
                                <label htmlFor="file-upload" className="custom-file-upload">
                                    <OverlayTrigger placement="bottom"
                                        overlay={<Tooltip>Haga clic para seleccionar una foto</Tooltip>}
                                    >
                            ...
                            <Col lg={2} id="edit-profile-icons">
                                {loading ? (
                                    <Spinner animation="border" />
                                        ...
                                        <>
                                            <OverlayTrigger placement="bottom"
                                                overlay={<Tooltip> Guardar cambios</Tooltip>}
                                            >
                                                <span onClick={handleSave}><TiTick /></span>
                                            </OverlayTrigger>
                                            <OverlayTrigger placement="bottom"
                                                overlay={<Tooltip>Descartar los cambios </Tooltip>}
                                            >
            ...
            <div className="container">
                <Row>
                    <Col lg={2} sm={12} id="aside">
                        <Button disabled variant="dark" id="active-sells">Ventas activas</Button>{' '}
                        <Button disabled variant="dark" id="archived-sells">Archivado</Button>{' '}
                        <Button disabled variant="dark" id="wishlist">Lista de deseos</Button>{' '}
                    </Col>
