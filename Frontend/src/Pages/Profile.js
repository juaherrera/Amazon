                ...
                <div className="container">
                    <Row>
                        <Col lg={2} sm={12} id="aside">
                            <Button variant="dark" id="active-sells" onClick={handleActive}>Ventas activas</Button>{' '}
                            <Button variant="dark" id="archived-sells" onClick={handleArchived}>Archivado</Button>{' '}
                            <Button variant="dark" id="wishlist" onClick={handleWish}>Lista de deseos</Button>{' '}
                        </Col>
                        <Col lg={10} sm={12}>
