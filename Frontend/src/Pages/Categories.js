...
function Categories({ match }) {
    ...
    const handleSearch = (e) => {
      ...
      return (
        <>
            <div id="sider">
                <input className="col-lg-6" type="text" placeholder="Buscar..." name="search" value={query} onChange={handleSearch} />
            </div>
            <CategoriesNav />
            <div className="container">
                <Dropdown id="dropdown-sort">
                    ...
                    <Dropdown.Menu>
                        <Dropdown.Item onClick={() => { setSort('oldest') }}>Más Antiguos <BiDownArrowAlt /></Dropdown.Item>
                        <Dropdown.Item onClick={() => { setSort('newest') }}>Más Recientes <BiUpArrowAlt /></Dropdown.Item>
                        <Dropdown.Item onClick={() => { setSort('lowerPrice') }}>Más Caro <BiSortDown /></Dropdown.Item>
                        <Dropdown.Item onClick={() => { setSort('biggerPrice') }}>Más Barato <BiSortUp /> </Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
                {!loading ?
                    <InfiniteScroll
